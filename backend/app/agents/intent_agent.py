...
{
    "intent": "用户的主要意图（例如：工作方法咨询、工作效率提升、时间管理、任务管理、项目管理、团队协作、沟通技巧、职业发展、企业培训课程咨询等企业工作相关主题）",
    ...
    "entities": {
        ...
        "is_work_method": "是否是工作方法相关咨询（true/false）"
    }
}
...
7. is_work_method 字段应该准确反映是否是工作方法相关的咨询"""
